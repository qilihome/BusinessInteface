...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="location" id="location">
			...
			<span class="location_bg">模块管理</span>
				...
				<c:choose>
					<c:when test="${empty moduleList}">
						<tr onmouseover="this.className='tr_on'" onmouseout="this.className=''">
							<td colspan="8" class="t9">未查询到模块信息，请添加模块！</td>
							<td class="t7"></td>
						</tr>
					</c:when>
					<c:otherwise>
						<c:forEach items="${moduleList}" var="item">
							<tr onmouseover="this.className='tr_on'" onmouseout="this.className=''">
								...
								<td class="t2"><a onclick="javascript: column(${item.id });" href="#"><img src="<%=request.getContextPath()%>/images/icon/icon_37.gif" alt="栏目管理" border="0" align="absmiddle" /></a></td>
								<td class="t8">
		...
		<script type="text/javascript" src="<%=request.getContextPath()%>/include/js/boss/module/module_list.js" ></script>
	</body>
</html>