...
<html lang="utf-8">
  ...
  <body>
    <form action="" id="forwadForm" method="post">
	    <div class="container">
	    	<div class="div-signin">
	           <legend><h1>添加专家点评</h1></legend>   
	           <div class="input-prepend input-append">
	             <span class="add-on">专家名称：</span>
	             <input id="name_expertReview" name="expertReviewForm.name" maxlength="20" class="input-xlarge" id="prependedInput" type="text" title="请输入专家名称" placeholder="请输入专家名称">
	             <span class="add-on text-error">*</span>
	           </div>  
	           <div class="input-prepend input-append">
	             <span class="add-on">专家头衔：</span>
	             <input id="title_expertReview" name="expertReviewForm.title" maxlength="100" class="input-xlarge" id="prependedInput" type="text" title="请输入专家头衔" placeholder="请输入专家头衔">
	             <span class="add-on text-error">*</span>
	           </div>  
	           <div class="input-prepend input-append">
	             <span class="add-on">专家荣誉：</span>
	             <textarea id="honor_expertReview" name="expertReviewForm.honor" class="input-xlarge" rows="3" placeholder="请输入专家荣誉"></textarea>
	             <span class="add-on text-error">*</span>
	           </div>  
	           <div class="input-prepend input-append">
	             <span class="add-on">上传专家头像：</span>
	             <input type="hidden" id="content_headsculpture" name="expertReviewForm.headsculpture" title="请上传专家头像" />
	        ...
	        <div class="div-signin">
	           <div class="input-prepend input-append">
	             ...
	             <input id="reviewsubject_expertReview" name="expertReviewForm.reviewsubject" maxlength="200" class="input-xlarge" id="prependedInput" type="text" title="请输入点评主题" placeholder="请输入点评主题">
	             <span class="add-on text-error">*</span>
	           </div>  
	           <div class="input-prepend input-append">
	             <span class="add-on">点评内容：</span>
	             <textarea id="reviewcontent_expertReview" name="expertReviewForm.reviewcontent" class="input-xlarge" rows="3" placeholder="请输入点评内容"></textarea>
	             <span class="add-on text-error">*</span>
	           </div>  
	        </div>
	        <div class="div-signin">
	            <button type="button" id="btn_upload_submit" class="btn btn-primary btn-large btn-block">添加专家点评</button>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/include/js/boss/expertreview/expertreview_add.js"></script>
