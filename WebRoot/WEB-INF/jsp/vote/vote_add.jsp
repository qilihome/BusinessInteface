...
<html lang="utf-8">
  ...
  <body>
    <form action="" id="forwadForm" method="post">
	    <div class="container">
	    	<div class="div-signin">
	           <legend><h1>添加投票活动</h1></legend>   
	           <div class="input-prepend input-append">
	             <span class="add-on">投票活动名称：</span>
	             <input id="name_vote" name="voteForm.name" maxlength="20" class="input-xlarge" id="prependedInput" type="text" title="请输入投票活动名称" placeholder="请输入投票活动名称">
	             <span class="add-on text-error">*</span>
	           </div>  
	        </div>
	        <div class="div-signin">
	            <button type="button" id="btn_upload_submit" class="btn btn-primary btn-large btn-block">添加投票活动</button>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/include/js/boss/vote/vote_add.js"></script>
  </body>
</html>