...
<html lang="utf-8">
  ...
  <body>
    <form action="" id="forwadForm" method="post">
    	<input type="hidden" name="voteOptionForm.id" value="${voteOption.id }">
    	<input type="hidden" name="voteOptionForm.voteid" value="${voteOption.voteid }">
	    <div class="container">
	    	<div class="div-signin">
	           <legend><h1>修改投票选项</h1></legend>   
	           <div class="input-prepend input-append">
	             <span class="add-on">投票选项名称：</span>
	             <input id="name_voteOption" name="voteOptionForm.name" value="${voteOption.name }" maxlength="20" class="input-xlarge" id="prependedInput" type="text" title="请输入投票选项名称" placeholder="请输入投票选项名称">
	             <span class="add-on text-error">*</span>
	           </div>  
	           <div class="input-prepend">
	             <span class="add-on">投票数量：</span>
	             <input id="votes_voteOption" name="voteOptionForm.votes" value="${voteOption.votes }" maxlength="20" class="input-xlarge" id="prependedInput" type="text" title="请输入投票数量" placeholder="请输入投票数量">
	           </div>
	        </div>
	        <div class="div-signin">
	            <button type="button" id="btn_upload_submit" class="btn btn-primary btn-large btn-block">修改投票选项</button>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/include/js/boss/vote/option/voteoption_edit.js"></script>
  </body>
</html>