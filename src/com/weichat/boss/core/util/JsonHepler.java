...
public class JsonHepler {
	private static String TAG = "JsonHepler";
...
//            Log.e(TAG, TAG  + ">>>>>>>>>>set value error.",e);
	 ...
	 */
	public static <T> T parseObject(String jsonStr, Class<T> clazz) throws JSONException, ParseException {
	 ...
	 * @throws ParseException 
	 */
	public static <T> T[] parseArray(String jsonStr, Class<T> clazz) throws ParseException {
		if (clazz == null || jsonStr == null || jsonStr.length() == 0) {
			return null;
		}
		JSONArray jo = null;
	...
	public static <T> Collection<T> parseCollection(String jsonStr, Class<?> collectionClazz,
			Class<T> genericType) throws JSONException, ParseException {
